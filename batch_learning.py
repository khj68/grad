...
X_train = df.loc[cur_num - 1000 :cur_num, 'review'].values
y_train = df.loc[cur_num - 1000 :cur_num, 'sentiment'].values
...
print('finish saving : downtime [%f]s' %(time()-stime))



if(cur_num + 1000 > data_size) :
